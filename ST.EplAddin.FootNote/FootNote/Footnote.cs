...
//TODO: отображение прикрепить к слоям
//TODO: возможность создания выносок на многополюсной схеме
//TODO: возможность добавления еще одной стрелочки

//Основные понятия объектов

//ViewPart- Представляет деталь, отображаемую в ViewPlacement
//Placement- Этот класс представляет любой объект, который можно разместить на странице проекта.
//Placement3D- Представляет объект из проекта, имеющий трехмерное представление.
//ViewPlacement-Класс представляет собой объект, который может отображать 3D-объекты на странице.
